...
であり、いちばん明らかに「よくできる」場所でもあります。動きます。ブラウザが送信し、
ハンドラが答え、エラーの乗ったページが返ってきます。足りないのは、往復を払う前に
「その入力は誤っている」と読み手が知る 0.5 秒です。

その 0.5 秒はブラウザが出せます。ブラウザに出せないのは、何が妥当かの判断です。
この 2 つを混ぜることが、このページの主題にあたる間違いです。
...
[ブラウザ標準の部品](/ja/interaction/controls/)にあります。
...
[フラグメントと島](/ja/interaction/fragments/)を参照してください。
