...
[Templates](/guides/templates/). For what to build on top of this surface —
dialogs the server fills, toasts, and where a swap stops being the cheapest
answer — see [Fragments and islands](/interaction/fragments/).
