...
why_capacity_is_configuration:
  ...
  scope: it applies at CreateTable; requirement:dynamodb-migration cannot change it afterwards, because the driver has no UpdateTable
validation:
  ...
  - provisioned billing requires both capacities, and pay_per_request rejects them
