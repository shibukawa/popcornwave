...
prerequisites:
  ...
  still_missing:
    ...
    scaffold_not_compiled: nothing here builds a scaffolded project under either tag, so the layout is asserted and the fixture is compiled; a project generated by pw init has never been through a fasthttp compiler
  open_here:
