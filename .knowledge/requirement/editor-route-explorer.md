...
```yaml
status: discovered routes implemented, over pw/routes; registered routes are not covered and the view says so, because finding them needs the resolved import graph
