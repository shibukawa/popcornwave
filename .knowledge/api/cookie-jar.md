...
---
One typed browser cookie, read and written through the same API whichever protection policy:cookie-value-protection mode it carries.
...
rules:
  ...
  - login state belongs to api:session-manager, not to a jar
context:
