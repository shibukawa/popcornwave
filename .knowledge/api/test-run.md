...
database:
  ...
  data: api:test-seed loads data:seed-dataset rows after the schema and before the test transaction
transaction:
  ...
  scope_note: WithSchemaDir and api:test-seed WithSeed run before and outside the test transaction
