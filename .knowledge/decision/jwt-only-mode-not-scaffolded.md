...
decision:
  ...
  init: api:cli-init does not offer it in the authentication question and does not accept it as an --auth value; the enum stays none, oidc, oidc-passkey, and passkey
