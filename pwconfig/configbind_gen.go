...
func registerRateLimitConfigDefinition2() {
	configbind.Register[RateLimitConfig](configbind.Definition{
		...
		DependsOn: map[string][]configbind.Dependency{
			...
			"ratelimit.redis.dsn":             {{Key: "ratelimit.enabled"}},
			"ratelimit.redis.key_prefix":      {{Key: "ratelimit.enabled"}},
			"ratelimit.redis.connect_timeout": {{Key: "ratelimit.enabled"}},
		},
...
func registerSessionConfigDefinition3() {
	configbind.Register[SessionConfig](configbind.Definition{
		...
		DependsOn: map[string][]configbind.Dependency{
			...
			"session.rdb.source":               {{Key: "session.enabled"}},
			"session.rdb.group":                {{Key: "session.enabled"}},
			"session.rdb.dsn":                  {{Key: "session.enabled"}},
			"session.rdb.table":                {{Key: "session.enabled"}},
			"session.redis.dsn":                {{Key: "session.enabled"}},
			"session.redis.key_prefix":         {{Key: "session.enabled"}},
			"session.redis.connect_timeout":    {{Key: "session.enabled"}},
			"session.cookie_store.name":        {{Key: "session.enabled"}},
			"session.keyring.secret":           {{Key: "session.enabled"}},
			"session.keyring.previous_secrets": {{Key: "session.enabled"}},
			"session.dynamo.table":             {{Key: "session.enabled"}},
			"session.dynamo.consistent_read":   {{Key: "session.enabled"}},
			"session.firestore.kind":           {{Key: "session.enabled"}},
		},
		Secrets: map[string]string{
