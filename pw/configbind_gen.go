...
func registerServerConfigDefinition0() {
	configbind.Register[ServerConfig](configbind.Definition{
		TypeName: "github.com/shibukawa/popcornwave/pw.ServerConfig",
		Prefix:   "server",
...
func registerSecurityConfigDefinition1() {
	configbind.Register[SecurityConfig](configbind.Definition{
		TypeName: "github.com/shibukawa/popcornwave/pw.SecurityConfig",
		Prefix:   "security",
		...
		DependsOn: map[string][]string{
			...
			"security.headers.frame_options":                       {"security.headers.enabled"},
			"security.headers.referrer_policy":                     {"security.headers.enabled"},
			"security.headers.content_security_policy":             {"security.headers.enabled"},
			"security.headers.content_security_policy_report_only": {"security.headers.enabled"},
			"security.headers.permissions_policy":                  {"security.headers.enabled"},
			"security.headers.hsts.enabled":                        {"security.headers.enabled"},
...
func registerObservabilityConfigDefinition3() {
	configbind.Register[ObservabilityConfig](configbind.Definition{
		...
		Doc:      "ObservabilityConfig controls runtime logging and service identity",
		KnownKeys: []string{
		...
		DependsOn: map[string][]string{
			"observability.query.level":            {"observability.query.enabled"},
			"observability.query.slow_threshold":   {"observability.query.enabled"},
			"observability.query.slow_level":       {"observability.query.slow_threshold"},
			"observability.query.bind_values":      {"observability.query.enabled"},
			"observability.query.explain":          {"observability.query.slow_threshold"},
