...
func registerConfigDefinition0() {
	configbind.Register[Config](configbind.Definition{
		...
		DependsOn: map[string][]configbind.Dependency{
			...
			"auth.assurance.hint.name":                  {{Key: "auth.enabled"}},
			"auth.assurance.hint.secret":                {{Key: "auth.enabled"}},
			"auth.assurance.hint.previous_secrets":      {{Key: "auth.enabled"}},
			"auth.assurance.hint.ttl":                   {{Key: "auth.enabled"}},
			"auth.assurance.hint.idle_timeout":          {{Key: "auth.enabled"}},
			"auth.assurance.presence.enabled":           {{Key: "auth.enabled"}},
			"auth.assurance.presence.interval":          {{Key: "auth.enabled"}},
			"auth.assurance.presence.absent_after":      {{Key: "auth.enabled"}},
			...
			"auth.oidc.issuer":                          {{Key: "auth.enabled"}},
			"auth.oidc.client_id":                       {{Key: "auth.enabled"}},
			"auth.oidc.client_secret":                   {{Key: "auth.enabled"}},
			"auth.oidc.redirect_url":                    {{Key: "auth.enabled"}},
			"auth.oidc.scopes":                          {{Key: "auth.enabled"}},
			"auth.oidc.endpoint_hosts":                  {{Key: "auth.enabled"}},
			"auth.oidc.identity_claim":                  {{Key: "auth.enabled"}},
			"auth.oidc.admission":                       {{Key: "auth.enabled"}},
			"auth.oidc.auto_provision":                  {{Key: "auth.enabled"}},
			"auth.oidc.claim.path":                      {{Key: "auth.enabled"}},
			"auth.oidc.claim.values":                    {{Key: "auth.enabled"}},
			"auth.oidc.claim.match":                     {{Key: "auth.enabled"}},
			"auth.oidc.registered_claims":               {{Key: "auth.enabled"}},
			"auth.oidc.logout_scope":                    {{Key: "auth.enabled"}},
			"auth.oidc.provider_logout":                 {{Key: "auth.enabled"}},
			"auth.oidc.allow_global_logout_request":     {{Key: "auth.enabled"}},
			"auth.oidc.allow_loopback_http":             {{Key: "auth.enabled"}},
			"auth.passkey.path":                         {{Key: "auth.enabled"}},
			"auth.passkey.rp_id":                        {{Key: "auth.enabled"}},
			"auth.passkey.rp_name":                      {{Key: "auth.enabled"}},
			"auth.passkey.origins":                      {{Key: "auth.enabled"}},
			"auth.passkey.user_verification":            {{Key: "auth.enabled"}},
			"auth.passkey.discoverable":                 {{Key: "auth.enabled"}},
			"auth.jwt.issuer":                           {{Key: "auth.enabled"}},
			"auth.jwt.audience":                         {{Key: "auth.enabled"}},
			"auth.jwt.audience_match":                   {{Key: "auth.enabled"}},
			"auth.jwt.algorithms":                       {{Key: "auth.enabled"}},
			"auth.jwt.required_token_type":              {{Key: "auth.enabled"}},
			"auth.jwt.required_scopes":                  {{Key: "auth.enabled"}},
			"auth.jwt.discovery":                        {{Key: "auth.enabled"}},
			"auth.jwt.jwks_uri":                         {{Key: "auth.enabled"}},
			"auth.jwt.leeway":                           {{Key: "auth.enabled"}},
			"auth.jwt.max_token_lifetime":               {{Key: "auth.enabled"}},
			"auth.jwt.max_token_bytes":                  {{Key: "auth.enabled"}},
			"auth.jwt.jwks_refresh_cooldown":            {{Key: "auth.enabled"}},
			"auth.jwt.allow_loopback_http":              {{Key: "auth.enabled"}},
			"auth.jwt.identity_claim":                   {{Key: "auth.enabled"}},
			"auth.jwt.admission":                        {{Key: "auth.enabled"}},
			"auth.jwt.auto_provision":                   {{Key: "auth.enabled"}},
			"auth.jwt.claim.path":                       {{Key: "auth.enabled"}},
			"auth.jwt.claim.values":                     {{Key: "auth.enabled"}},
			"auth.jwt.claim.match":                      {{Key: "auth.enabled"}},
			"auth.jwt.registered_claims":                {{Key: "auth.enabled"}},
			"auth.jwt.revocation.mode":                  {{Key: "auth.enabled"}},
			"auth.jwt.revocation.on_unavailable":        {{Key: "auth.enabled"}},
			"auth.jwt.revocation.max_propagation_delay": {{Key: "auth.enabled"}},
			"auth.jwt.dev.trust_unverified_tokens":      {{Key: "auth.enabled"}},
		},
