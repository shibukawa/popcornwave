...
func init() {
	register(
		...
		Check{
			...
			Title:    "a declared package was generated by a newer Popcorn Web",
			Severity: Warning, DevSeverity: Warning, Scope: Every,
			Inputs: ProjectFiles | Config, Phase: Doctor,
			...
			Remedy: "upgrade this project's Popcorn Web, or pin the package to a version generated against it",
		},
		Check{
