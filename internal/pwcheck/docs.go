...
//
// The prose below is the page's prose. A pass that improves the Japanese has to
// improve it here: editing the generated file instead leaves the two disagreeing,
// and the next regeneration silently discards the better version.
